...
\begin{verbatim}
chr11:118,092,641-118,095,026 peakStart tcell
chr11:118,095,334-118,096,640 peakEnd tcell
chr11:118,101,452-118,118,472 noPeaks
chr11:118,121,649-118,124,175 peaks tcell bcell
...
\begin{frame}
  ...
  \item Faster algorithm via constrained version of
    \begin{tabular}{rllll}
      ...
      % & arXiv:1004.0887 
      \\
      $O(d\log d)$ & 1 & FPOP & Maidstone et al. 2014 % & arXiv:1409.1842 
    \end{tabular}
    \\
