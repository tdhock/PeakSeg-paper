...
\begin{table}[b!]
  \centering
  \begin{tabular}{ccc}
    \textbf{learned} & \textbf{heuristic} & \textbf{max likelihood} \\
    \textbf{params} & \textbf{algorithms} & \textbf{segmentation} \\
    \hline
    0 & hmcan.broad.default & oracle.default \\
     & macs.default & AIC/BIC/mBIC \\
     \hline
     1 & hmcan.broad.trained & oracle.trained \\
     & macs.trained & s.constant \\
     \hline 
     $>1$ & --- & L1.reg, oracle.2/41 \\
      && log.bases.log.max
  \end{tabular}
  \caption{Comparison of peak detection methods for ChIP-seq data. 
    ...
    using maximum likelihood segmentation and 
    multi-parameter supervised learning algorithms.}
