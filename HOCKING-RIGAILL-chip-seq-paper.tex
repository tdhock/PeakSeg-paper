...
In the end we get the algorithm \ref{algo:v2}. 


\begin{algorithm}[H]
\begin{algorithmic}[1]
\REQUIRE $s_{max}$, $y_j$ (a vector of size $d$)
...
\STATE $ \widehat{m}_{s,t} = \underset{t' \leq t| \mathbf{E}_{s-1,t} \leq M_{t', t}} {\arg \min}\{ \ \widehat{\mathcal{L}}_{s-1,t'} + c_{t', t} \ \}$
\ENDIF
\IF{$d$ is odd}
\STATE $ \widehat{\mathcal{L}}_{s,t} = \underset{t' \geq t | \mathbf{E}_{s-1,t'} \geq M_{t', t} }{\min} \{ \ \widehat{\mathcal{L}}_{s,t'} + c_{t',t} \ \}$
\STATE $ \widehat{m}_{s,t} = \underset{t' \geq t | \mathbf{E}_{s-1,t'} \geq M_{t', t} }{\arg \min} \{ \ \widehat{\mathcal{L}}_{s,t'} + c_{t',t} \ \}$
\ENDIF
...
Hence this procedure is not guaranteed to recover a
segmentation. For an ever increasing series of data $y_1 <
