...
cDPA is not guaranteed to compute the \ref{PeakSeg} model. This is
mostly a theoretical issue, since in real data sets the cDPA is very
effective (Section~\ref{sec:heuristic-effectiveness}).
